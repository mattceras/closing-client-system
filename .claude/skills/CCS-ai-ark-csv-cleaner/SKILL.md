...
This is the default path for every user — the manual export in AI Ark, then hand the file to Claude. Don't reach for the API path (see Advanced section below) unless the user has explicitly set up an AI Ark API key and asks for it.
