...
- Never carry over Parkmont Advisory's specific numbers, verticals, or forbidden-word list into a different user's output — those were built for one specific business, not a template to inherit by default.
