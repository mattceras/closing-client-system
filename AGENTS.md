...
This folder is a self-contained Codex setup for running cold email outreach end-to-end: building lead lists, cleaning and enriching them, writing copy, uploading campaigns, and running the sales process on the replies you get. Everything it needs lives in this folder — skills, config, and client data all travel together.
