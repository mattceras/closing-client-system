...
| | **Tier A — AI assistant writes** | **Tier B — Lead Formatter writes** |
|---|---|---|
| Size | ≤1,000 leads / ≤300 firms | 3,000+ leads |
| Who writes | The AI assistant, in batches | Lead Formatter, per row |
| Quality | Highest | ~85-90% as good |
| Cost sits on | AI-platform usage | AirScale/Clay per-row pricing |
